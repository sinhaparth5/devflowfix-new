...
## 📁 app/core/schemas/ - Pydantic Schemas (API Contracts)
...
- Steps: normalize → analyze → decide → execute → log
**Example**:
```python
...
## 📁 app/services/confidence/ - Confidence Scoring Subsystem
